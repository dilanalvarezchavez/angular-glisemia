    ...
    <div class="card-body">
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group">
                ...
                <input aria-describedby="ciHelpBlock" id="ci" type="ci" class="form-control{{ $errors->has('ci') ? ' is-invalid' : '' }}" name="ci" placeholder="Enter ci" tabindex="1" value="{{ (Cookie::get('ci') !== null) ? Cookie::get('ci') : old('ci') }}" autofocus required>
